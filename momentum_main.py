...
class BetatronApplication(QtWidgets.QApplication):
    def __init__(self, *args, **kwargs):
        ...
        self.focus_learning_rate = 5
        self.second_dispersion_learning_rate = 5
        self.third_dispersion_learning_rate = 5

        self.IMG_PATH = r'C:\Users\blehe\Desktop\betatron_momentum\images'
            ...
            if self.run_count % self.n_images == 0:
                ...
                if self.n_images_run_count == 1:
                    ...
                    if self.n_images_run_count == 1:     
                        ...
                        self.initial_optimize() # take random directions, second data point for optimization algorithm 

                if self.n_images_run_count >= 2:
                    self.n_images_dir_run_count += 1
                    self.optimize_count()

                self.write_values() # adjust values and send via FTP connection
